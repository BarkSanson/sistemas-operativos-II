...
../build/leer disco 2
echo "################################################################################"
echo "$ ../build/leer disco 5 > ext3.txt"
